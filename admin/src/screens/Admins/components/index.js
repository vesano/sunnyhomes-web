...
class Admins extends React.Component {
  ...
  renderPagination = () => {
    const {isLoading, page, limit, total} = this.props.Admins
      ...
      <div className="col-12">
        <div className="card shadow-sm my-3">
          <div className="card-header">
            <div className="row">
              <div className="col">
                <h3 className="m-0">{i18n.t('admins.title')}</h3>
              </div>
              <div className="col-12 col-md-auto text-right">
                <Link className="btn btn-primary transition-3d-hover"
                      to={Pages.ADMINS_NEW}>
                  <i className="fa fa-plus"/>&nbsp;{i18n.t('admins.new_action')}
                </Link>
              </div>
            </div>
          </div>
...
export default connect(selectors)(Admins)
